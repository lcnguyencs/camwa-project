...
@Component({
  selector: 'module-detail-create-admin',
  standalone: true, 
  imports: [CommonModule, ActionTableComponent, PopupAttendanceComponent],
  templateUrl: './module-detail-create-admin.component.html',
  styleUrls: ['./module-detail-create-admin.component.scss'],
})
export class ModuleDetailCreateAdminComponent {
