...
@Component({
  selector: 'module-detail-modify-admin',
  standalone: true, 
  imports: [CommonModule, ActionTableComponent, PopupAttendanceComponent],
  templateUrl: './module-detail-modify-admin.component.html',
  styleUrls: ['./module-detail-modify-admin.component.scss'],
})
export class ModuleDetailModifyAdminComponent {
