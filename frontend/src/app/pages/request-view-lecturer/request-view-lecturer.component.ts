...
@Component({
  selector: "request-view-lecturer-view",
  standalone: true,
  imports: [CommonModule, RouterModule],
  templateUrl: "./request-view-lecturer.component.html",
  styleUrl: "./request-view-lecturer.component.css",
})
export class RequestViewLecturerComponent {
  requestData = [
    {
      moduleID: "CS1",
